...
use MiniRoute\Traits\RouteTrait;
...
final class Route
{
     ...
     *
     * @return mixed The handler of the Route.
     */
    ...
    /**
     * Returns the handler action of the Route.
     *
     * @return string The handler action of the Route.
     */
